...
### `Data Dictionary.md`
Markdown reference for the structure and content of `ENVELOPE.csv`, `WHOLE_BLDG.csv`, and `ZONE.csv`. It is organized in three sections (one per CSV), with tables that define each column’s purpose, expected data type, and units where applicable.
