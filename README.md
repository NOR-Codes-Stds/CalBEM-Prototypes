...
Development of nonresidential building prototypes is currently available for testing and review. The preliminary phases—building stock assessment, vintage categorization, and prototype definition—have been completed. At present, 21 nonresidential prototype models have been created, accompanied by detailed scorecards, EnergyPlus IDF files, and associated databases. 
...
1. Validation: Prototype models were validated at the end-use level using stock energy consumption data from the 2019 Residential Appliance Saturation Survey (RASS) for single-family and multifamily buildings. For nonresidential prototypes, the 2022 Commercial End-Use Survey (CEUS) and the national Portfolio Manager database were utilized to ensure consistency and accuracy in energy performance benchmarks.
